$(document).ready(function() {
    ...
    $("#editQCM").on("click", ".addReponse", function() {
        ...
        var newReponse = '<div class="reponse"><label>Réponse ' + reponseIndex + '</label><input type="text" name="reponse' + questionIndex + reponseIndex +'"><input type="checkbox" class="checkbox"name="correction' + questionIndex +reponseIndex + '" value="true"> Vrai <input type="checkbox" class="checkbox"name="correction' + questionIndex + reponseIndex + '" value=""> Faux <button type="button" class="removeReponse">Supprimer la réponse</button></div>';
